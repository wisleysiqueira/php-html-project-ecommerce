<?php if(!class_exists('Rain\Tpl')){exit;}?><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
    ...
    <input type="hidden" name="business" value="wisleysiqueira@hotmail.com">
    ...
    <?php } ?>
    <input type="hidden" name="item_shipping_cost_" value="<?php echo htmlspecialchars( $order["vlfreight"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
