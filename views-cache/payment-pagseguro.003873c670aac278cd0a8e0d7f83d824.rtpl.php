...
action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
        ...
        <!-- Campos obrigatórios -->  
        <input name="receiverEmail" type="hidden" value="wisleysiqueira@hotmail.com">  
        ...
        <input name="itemShippingCost1" type="hidden" value="<?php echo htmlspecialchars( $cart["vlfreight"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
